...
struct ItemData { int id = -1; std::string name = ""; std::string type = ""; float heal = 0.0f; float atkBonus = 0.0f; float defBonus = 0.0f; float hpBonus = 0.0f; float speedBonus = 0.0f; float dropChance = 0.0f; int weaponSubtype = -1; int count = 1; int modifierId = 0; };
...
struct SkillNode { int id = 0; std::string name = ""; Vector2 uiPos = { 0.0f, 0.0f }; std::vector<int> reqIds; bool unlocked = false; int cost = 1; float atkAdd = 0.0f; float defAdd = 0.0f; float hpAdd = 0.0f; SkillType type = SKILL_PASSIVE; float maxCooldown = 0.0f; };
